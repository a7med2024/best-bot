...
const discord_token = "NTMyNjE5Njk0MDcxNDgwMzQw.DxfITg.SlQ5kwQRK0uO-WcHdGxYLHyY8Ug";
...
client.on('ready', function(){
    var ms = 60000 ;
    var setGame = [`${client.guilds.size} Server`,' A7med Bot™ by a7med ','Type -help |-support |-invite ',`${client.users.size} Members`,'-invite','By: n3k4a & Hosam | BaronTube'];
    var i = -1;
    var j = 0;
